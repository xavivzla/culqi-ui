<template>
  <div class="main-nav-content">
    <div v-show="responsive">
      ...
      <!-- <router-link to="/components/drawer-culqi">{{ $t('pages.drawerCulqi.title') }}</router-link> -->
      <!-- <router-link to="/components/filter-culqi">{{ $t('pages.filterCulqi.title') }}</router-link> -->
      <!-- <router-link to="/components/collapse">{{ $t('pages.collapse.title') }}</router-link>
      <router-link to="/components/timeline">{{ $t('pages.timeline.title') }}</router-link>
    ...
    <div class="main-nav-level">
      ...
      <router-link to="/components/culqi">{{ $t('pages.culqi.title') }}</router-link>
      <div class="main-nav-level">
        <router-link to="/components/drawer-culqi">{{ $t('pages.drawerCulqi.title') }}</router-link>
        <router-link to="/components/filter-culqi">{{ $t('pages.filterCulqi.title') }}</router-link>
        <router-link to="/components/switch-culqi">{{ $t('pages.switchCulqi.title') }}</router-link>
        <router-link to="/components/dual-timepicker">{{ $t('pages.dualTimepicker.title') }}</router-link>
        <router-link to="/components/collapse">{{ $t('pages.collapse.title') }}</router-link>
        <router-link to="/components/timeline">{{ $t('pages.timeline.title') }}</router-link>
        <router-link to="/components/modal">{{ $t('pages.modal.title') }}</router-link>
      </div>
