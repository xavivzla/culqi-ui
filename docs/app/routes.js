export const routes = [
  ...
  },
  {
    ...
    page: 'Components/Modal/Modal.vue'
  },
  {
    path: '/components/timeline',
    name: 'components/timeline',
    page: 'Components/Timeline/Timeline.vue'
  },
  {
    path: '/components/collapse',
    name: 'components/collapse',
    page: 'Components/Collapse/Collapse.vue'
  },
  {
    path: '/components/culqi',
    name: 'components/culqi',
    redirect: '/components/drawer-culqi'
  },
  {
    path: '/components/drawer-culqi',
    name: 'components/drawer-culqi',
    page: 'Components/DrawerCulqi/DrawerCulqi.vue'
  },
  {
    path: '/components/filter-culqi',
    name: 'components/filter-culqi',
    page: 'Components/FilterCulqi/FilterCulqi.vue'
  },
  {
    path: '/components/switch-culqi',
    name: 'components/switch-culqi',
    page: 'Components/SwitchCulqi/SwitchCulqi.vue'
  },
  {
    path: '/components/dual-timepicker',
    name: 'components/dual-timepicker',
    page: 'Components/DualTimepicker/DualTimepicker.vue'
  },
  {
