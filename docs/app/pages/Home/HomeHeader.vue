<template>
  <header class="home-header">
    ...
    <div class="home-call">
      <h1 class="home-name">Culqi UI</h1>
      ...
      <!-- <div class="home-actions">
        ...
        <github-button href="https://github.com/sponsors/vuematerial" 
          data-icon="octicon-heart" data-size="large" aria-label="Sponsor @vuematerial on GitHub">Sponsor</github-button>
      </div> -->
      <!-- <div class="home-actions">
