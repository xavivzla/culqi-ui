<template>
  <page-container centered :title="$t('pages.themeConfiguration.title')">
    ...
    <div class="page-container-section">
      ...
      <code-example label="SCSS" lang="scss">
        @import "~culqi-ui/dist/theme/engine"; // Import the theme engine
        ...
        @import "~culqi-ui/dist/theme/all"; // Apply the theme
      </code-example>
    </div>
    ...
    <div class="page-container-section">
      ...
      <code-example label="SCSS" lang="scss">
        ...
        @import "~culqi-ui/dist/components/MdButton/theme"; // Apply the Button theme
        @import "~culqi-ui/dist/components/MdContent/theme"; // Apply the Content theme
        @import "~culqi-ui/dist/components/MdToolbar/theme"; // Apply the Toolbar theme
      </code-example>
    </div>
  </page-container>
</template>
