<example src="./examples/SwitchCulqiMoney.vue" />

<template>
  <page-container centered :title="$t('pages.switchCulqi.title')">
    ...
    <div class="page-container-section">
      ...
      <code-example title="Money" :component="examples['switch-culqi-money']" />


      <api-item title="API - md-switch-culqi">
