export default {
  home: {
    title: 'Home',
    slogan: 'Build beautiful apps with Culqi Design and Vue.js',
  ...
  culqi: {
    title: 'Culqi',
    description: 'Culqi indicators are visual indications of an app loading content.'
  },
  progressBar: {
    title: 'Progress Bar',
    nav: 'Bar'
