<template>
  <md-field :class="['md-dual-timepicker', { 'md-native': !this.mdOverrideNative }]" :md-clearable="mdClearable" @md-clear="onClear">
    ...
    <md-overlay class="md-dual-timepicker-overlay" md-fixed :md-active="showDialog" @click="toggleDialog" />
...
<script>
  ...
  import MdDualTimepickerDialog from './MdDualTimepickerDialog'
  ...
  export default {
    name: 'MdDualTimepicker',
    components: {
      MdOverlay,
      MdDateIcon,
      MdField,
      // MdInput,
      MdDualTimepickerDialog
    },
    props: {
