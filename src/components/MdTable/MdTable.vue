  ...
  <md-tag-switcher :md-tag="contentTag" class="md-table">
    ...
    <md-content class="md-table-content md-scrollbar" :class="contentClasses" :style="contentStyles" @scroll="setScroll">
      <table ref="contentTable">
        ...
        <fragment v-if="!$scopedSlots['md-table-row']">
          <slot />
        </fragment>

        <fragment v-else-if="value.length">
          <md-table-row-ghost
            ...
            :md-collapse-data="collapseData"
            :md-item="item">
            <slot name="md-table-row" :item="item" :collapse="collapse" :index="index" />
          </md-table-row-ghost>
        </fragment>

        <fragment v-else-if="$scopedSlots['md-table-empty-state']">
          <tr>
...
<script>
  ...
  import MdTableCollapse from './MdTableCollapse'
