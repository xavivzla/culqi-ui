<template>
  <div class="md-table-pagination">
    <div class="md-table-pagination-content-items">
    ...
    <div class="md-table-pagination-content-nums">
      ...
      <md-button v-for="item in generatePaginated" :key="item"
        class="md-custom-button-pagination"
