<template>
  <div class="md-avatar-media-cover" :class="coverClasses">
    <slot />
    <div class="md-avatar-backdrop" :style="coverStyles" v-if="mdTextScrim" ref="backdrop"></div>
  </div>
</template>

<script>
  export default {
    name: 'MdavatarMediaCover',
    props: {
      mdTextScrim: Boolean,
      mdSolid: Boolean
    },
    ...
    methods: {
      ...
      applySolidColor (darkness) {
        let area = this.$el.querySelector('.md-avatar-area')
