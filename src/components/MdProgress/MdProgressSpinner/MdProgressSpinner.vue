<template>
  <transition name="md-progress-spinner" appear>
    <div class="md-progress-spinner" :class="[progressClasses, $mdActiveTheme]">
      <span v-if="showValue" class="md-progress-spinner__value">{{mdValue}}</span>
      <svg
        ...
        <circle v-if="showLinear" class="md-progress-spinner-circle" cx="50%" cy="50%" :r="circleRadius" ref="md-progress-spinner-circle"></circle>
